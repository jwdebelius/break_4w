"""
This needs some documentation at some point
"""
...
class DataDictionary(OrderedDict):
    """
    Builds a data dictionary object
    """
    ...
    def __init__(self, columns, types, description=None):
        ...
        columns: list of dicts
            ...
            for each type of question object in a data dictionary. Each type must
            contain, at a minimum, the following information:
                * name
                * description of the variable of no more than 80 characters
